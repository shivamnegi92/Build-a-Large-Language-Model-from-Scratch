from data_setup.instruction_dataset import train_loader, val_loader, test_loader, format_input
...
# Load model
model.load_state_dict(torch.load("gpt2-medium355M-sft.pth", map_location=device, weights_only=True))
...
# Some of the responses generated by the finetuned model
...
# . short-answer and multiple choice benchmarks such as MMLU ("Measuring Massive Multitask Language Understanding", 
# https://arxiv.org/abs/2009.03300), which test the knowledge of a model
