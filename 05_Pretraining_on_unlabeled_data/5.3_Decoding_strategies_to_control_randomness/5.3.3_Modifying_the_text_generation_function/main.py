...
# . Both temperature and top-k settings have to be adjusted based on the individual LLM (a kind of trial and error process until it 
#   generates desirable outputs)

# . The desirable outcomes are also application-specific, though

# . Lower top-k and temperatures result in less random outcomes, which is desired when creating educational content, 
#   technical writing or question answering, data analyses, code generation, and so forth

# . Higher top-k and temperatures result in more diverse and random outputs, which is more desirable for brainstorming tasks, 
