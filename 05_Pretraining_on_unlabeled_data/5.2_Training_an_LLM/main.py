...
# cuda and cpu provide good training results. Loss is lowered quite quickly.
# However on mps the training results are not great. Loss stagnates and does not lower.
if torch.cuda.is_available():
    device = torch.device("cuda")
elif torch.backends.mps.is_available():
    device = torch.device("mps") 
else:
    device = torch.device("cpu") # Opt for this option on Apple Silicon
