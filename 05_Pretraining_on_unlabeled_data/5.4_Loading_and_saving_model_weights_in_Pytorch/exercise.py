...
# If we are still in the Python session where you first trained the model in chapter 5, to continue the pretraining for one more epoch, 
# we just have to load the model and optimizer that we saved in the main chapter and call the train_model_simple function again
